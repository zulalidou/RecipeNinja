...
if (mealTypes.includes(foodSearched)) getFoods("type", foodSearched, recipeNum, currentPage)
else if (cuisines.includes(foodSearched)) getFoods("cuisine", foodSearched, recipeNum, currentPage)
else getFoods(null, foodSearched, recipeNum, currentPage)
